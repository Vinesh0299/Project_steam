      ...
      <p style="text-align: center; color: rgb(230, 48, 48);">An error occurred!! Try logging in again!</p>
        ...
        <center>
            <form action="dev_login.php" method="POST">
                ...
                <p>Click <a href="devloper_signup_form.php">here</a> to make a free account</p>
            </form>
        </center>    
